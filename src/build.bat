...
set Pincludes="G:\C++ Projects\IncodeEngine\src\include"
set Plibs="G:\C++ Projects\IncodeEngine\src\lib"
...
set CommonLinkerFlags=-incremental:no -opt:ref /LIBPATH:%Plibs% SDL2.lib SDL2main.lib opengl32.lib glew32.lib user32.lib
